...
//        $Html->Body(
//                $Html->CreateTab("tabs")->NewTab("tabela", ["caption"=>"Nova Tabela"])->NewTab("NovaAba", ["csption"=>"Nova Aba Teste"])->CloseTabs(),
//                $Html->CreateContentTab("tabela", "index", true, 
//                        $Html->CreateRowBootstrap("",
//                                $Html->CreateColBootstrap("", 12, 12, 12, 12,
//                                            $Html->CreateLabel("Minha Nova Tabela"),
//                                        $Html->TextBox("noo")
//                                        )
//                                )
//                    )
